...
let scale=.97, regionNameGroup = {}, filteredPopData, groupedArea, groupedCountry, groupedRegion;
...
function countryclicked() {
  ...
  // console.log(regionNameGroup)

  const countryLink = d3.select(".popup-body")
    ...
    countryLink.each(function(d){
      ...
      divlist.each(function(d) {
        // if (d[0] === Object.values(regionNameGroup)) {
        //   console.log(d[0])
        // }
